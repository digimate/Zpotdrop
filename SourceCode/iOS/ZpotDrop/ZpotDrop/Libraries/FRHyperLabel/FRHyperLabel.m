...
+ (void)initialize {
	if (self == [FRHyperLabel class]) {
        ...
        ZDGreyColor = [UIColor colorWithRed:125/255.0 green:125/255.0 blue:125/255.0 alpha:1];
	}
}
...
//									  NSUnderlineStyleAttributeName: @(NSUnderlineStyleSingle)};
        ...
        self.linkAttributeDefault = @{NSForegroundColorAttributeName: ZDGreyColor};
